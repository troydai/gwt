...
- `gwtree switch <branch>` now checks if the current branch matches the requested branch. If so, it prints a warning and exits without creating a new worktree. ⚠️
